...
class CPUPlayer {
    ...
    private final Mark markAdverse;
    ...
    public ArrayList<Move> getNextMoveMinMax(Board board) {
        ...
        ArrayList<Move> coupsPossibles = new ArrayList<>(board.coupsPossibles());
    ...
    public int miniMax(Board board, String joueur){
        ...
        ArrayList<Move> coups = new ArrayList<>(board.coupsPossibles());
        int meilleur;
